...
public class BasicAuthenticationTest {
    ...
    void test_3() {
        ...
        // TestRestTemaplte은 BasicToken 을 지원함
    ...
    void test_4() {
        ...
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "shbae", String.class);
        assertEquals("hello shbae", resp.getBody());
    }
