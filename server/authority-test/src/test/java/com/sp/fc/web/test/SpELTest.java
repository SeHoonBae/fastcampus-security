...
public class SpELTest {
    ...
    void test_4() {
        ...
        assertFalse(parser.parseExpression("#horse.over(170)").getValue(ctx, Boolean.class)); // variable 사용할 때 #horse
        assertTrue(parser.parseExpression("@person.over(170)").getValue(person, Boolean.class)); // bean을 사용할 때 @person
        assertFalse(parser.parseExpression("@nancy.over(170)").getValue(nancy, Boolean.class));
    }
